...
export const story: string[] = [
  ...
  'My web development journey started with HTML, CSS and PHP as I aimed from start to become a full stack developer. Over the years I have gained loads of experience working on various projects and technologies from backend to frontend to working on large databases.'
]
